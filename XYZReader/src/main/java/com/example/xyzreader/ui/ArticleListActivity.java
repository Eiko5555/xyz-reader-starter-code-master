...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = getLayoutInflater().inflate(R.layout.list_item_article,
                    parent, false);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.i("clicked photo", "listactivity");
                }
            });
            return vh;
        }
        ...
        public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
            ...
            Target target = new Target() {
                ...
                public void onPrepareLoad(Drawable placeHolderDrawable) {
                    holder.thumbnailView.setImageResource(
                            R.drawable.photo_background_protection);
                }
            };
            String image = mCursor.getString(ArticleLoader.Query.THUMB_URL);
            Log.i("listActivityimageUrl", image);
